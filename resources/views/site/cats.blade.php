                ...
                <div class="row">
                    @if (!empty($cats)&&count($cats)>0)
                        ...
                        @foreach($cats as $cat)
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="content text-right">
                                                <h5>{{$cat->name}}</h5>
                                                <p><small>{{$cat->description}}</small>
                                                    <br><span style="    line-height: 3.5;"><a href="{{url('category/'.$cat->id)}}">زيارة القسم...</a></span>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            @endforeach
                        @else
                        <h2 class="text-center bg-youtube p-5">لايوجد أقسام فرعية تابعة لهذا القسم</h2>
                    @endif
