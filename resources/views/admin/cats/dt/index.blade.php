        ...
        <div class="col-md-12">
            <div class="box box-danger">
                <div class="box-header">
                    <div class="row">
                        <div class="col-md-6"><h3 class="box-title">جميع الأقسام</h3></div>
                        <div class="col-md-6 text-left"><a class="text-left btn btn-primary" href="{{url('admin/cats/add')}}">إضافة قسم جديد <i class="fa fa-plus"></i></a></div>
                    </div>
